...
describe "Reservation class" do
  ...
  it "can calculate and return the cost of a reservation for a single night/2 day" do
    start_date = Date.parse('2001-02-03')
  ...
  it "will return 200 for a single day reservation" do
    start_date = Date.parse('2001-02-03')
    end_date = Date.parse('2001-02-03')
